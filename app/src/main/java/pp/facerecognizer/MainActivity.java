...
* objects.
*/
public class MainActivity extends CameraActivity implements OnImageAvailableListener, TextToSpeech.OnInitListener {
    public static final String EXTRA_MESSAGE = "com.example.facerecognizer.MESSAGE";
...
//
            ...
            try {
                ...
                LOGGER.e("Exception setting up initial files!", e);
                finish();
            }
    ...
    protected void processImage() {
        ...
        runInBackground(
                () -> {
                    ...
                    {
                        String recognized_person = mappedRecognitions.get(0).getTitle();
                        // only notify the user when a new face appears
                        if (!Objects.equals(recognized_person, notified_person)){


                            speakWords("this is "+recognized_person);
                            notified_person = recognized_person;
                        }
                    }
...
//        if(recognizer.getSpeechFlag())
//        {
//            String recognized_person = recognizer.getSpeechName();
//            // only notify the user when a new face appears
//            if (!Objects.equals(recognized_person, notified_person)){
//                speakWords("this is "+recognized_person);
//                notified_person = recognized_person;
...
//        }
    ...
    // TODO: override the oninit medthod for main acivity doesn't seems right
    @Override
